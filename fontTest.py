...
#
#
# # this makes the messages appear on line belo
# def play():
#     current_page = 0
#     PLAY_BACK = Button(image=None, pos=(170, 510),
#                        text_input="BACK", font=get_font(60), base_color="White", hovering_color="Green")
#     PLAY_NEXT = Button(image=None, pos=(50, 50),
#                        text_input="NEXT", font=get_font(36), base_color="White", hovering_color="Green")
#
#     script_BG = pygame.image.load("scriptBG.png")
#     BG2 = pygame.transform.scale(script_BG, (SCREEN_WIDTH, SCREEN_HEIGHT))
#
#     messages = ["The love of your squirrel life is at the top!"," Climb up & reunite with your beloved!"," Have fun!"]
#
#     font = get_font(40)
#
#     text_x = 250
...
#         SCREEN.blit(BG2, (0, 0))
#
#         if counter < speed * len(messages[-1]):
#             counter += 1
#
#         for line_index, message in enumerate(messages):
#             line_y = text_y + line_index * (font.get_linesize() + line_spacing)
#             rendered_text = ""
#
...
#
#
# # def display_script_bg():
# #     # Display the script background
# #     script_screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
# #     script_screen.blit(script_BG, (0, 0))
# #     pygame.display.flip()
# #
#
# main_menu()
